  ...
  classes.forEach((class_) => {
    ...
    row.innerHTML = `
            ...
            <td class="px-4 py-3">
                ...
                <div class="flex items-center space-x-4 text-sm">
                    <a href="teacher-class-view.html?classId=${
                      class_.id
                    }" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Open Class">
